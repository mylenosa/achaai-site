...
export const NoResultTips: React.FC<NoResultTipsProps> = ({ tips, onAddItem }) => {
  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-4 md:p-5 max-h-56 flex flex-col">
        ...
        {tips.map((tip, index) => (
          ...
          >
            <div className="flex-1 min-w-0">
              ...
              <span className="text-gray-500 text-sm ml-2">— {tip.qtd} buscas</span>
            </div>
            <button
