      ...
      <div className="min-h-screen bg-gradient-to-br from-emerald-50 to-blue-50 flex items-center justify-center px-4">
        <div className="max-w-md mx-auto">
          ...
          >
            ...
            <h1 className="text-2xl font-bold text-gray-800 mb-4">Link de Acesso Enviado!</h1>

            <p className="text-gray-600 mb-6">
              Enviamos um link de acesso para <strong>{email}</strong>. Clique no link para fazer
      ...
      <div className="min-h-screen bg-gradient-to-br from-emerald-50 to-blue-50 flex items-center justify-center px-4">
        <div className="max-w-md mx-auto">
          ...
          >
            ...
            <h1 className="text-2xl font-bold text-gray-800 mb-4">E-mail de Recuperação Enviado!</h1>

            <p className="text-gray-600 mb-6">
              Enviamos um link para redefinir sua senha para <strong>{email}</strong>. Verifique sua
              caixa de entrada e clique no link.
            </p>
      ...
      <div className="max-w-sm sm:max-w-md mx-auto w-full">
        ...
        >
          ...
          <div className="text-center mb-6 sm:mb-8">
            ...
            <h1 className="text-2xl sm:text-3xl font-bold text-gray-800">Portal {config.app.name}</h1>
            <p className="text-gray-600 mt-2 text-base sm:text-lg">Acesse sua conta de lojista</p>
          </div>
